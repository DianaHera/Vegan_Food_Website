...
CREATE USER diana13 WITH ENCRYPTED PASSWORD 'parolapa55';
GRANT ALL PRIVILEGES ON DATABASE cti_2024 TO diana13 ;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO diana13;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO diana13;