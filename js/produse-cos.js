window.addEventListener("load",  function(){
    ...
    */
    for(let idp of iduriProduse){
        //idp ia pe rand prod din cos si returneaza ch (checkbox)
    ...
    for(let ch of checkboxuri){
        ch.onchange=function(){
            ...
            if( this.checked){
                ...
                let poz= iduriProduse.indexOf(this.value); //indexOf e poz, o cauta
                if(poz != -1){
                    iduriProduse.splice(poz,1);//splice il taie de pe pozitia respectiva
                }
            }
